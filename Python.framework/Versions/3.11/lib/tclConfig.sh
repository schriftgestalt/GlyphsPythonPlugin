...
# build directory.
TCL_BUILD_LIB_SPEC='-L/private/tmp/_py/_bld/tcl8.6.12/unix -ltcl8.6'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/private/tmp/_py/_bld/tcl8.6.12/unix -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='/private/tmp/_py/_bld/tcl8.6.12/unix/libtclstub8.6.a'
